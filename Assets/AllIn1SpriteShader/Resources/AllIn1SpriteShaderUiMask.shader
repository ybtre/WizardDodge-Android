Shader "AllIn1SpriteShader/AllIn1SpriteShaderUiMask"
{
	Properties
	{
		...
		_ColorChangeTolerance2("Tolerance 2", Range(0, 1)) = 0.25 //143
		_ColorChangeTarget2("Color to change 2", Color) = (1, 0, 0, 1) //144
		[HDR]_ColorChangeNewCol2("New Color 2", Color) = (1, 1, 0, 1) //145
		_ColorChangeTolerance3("Tolerance 3", Range(0, 1)) = 0.25 //146
		_ColorChangeTarget3("Color to change 3", Color) = (1, 0, 0, 1) //147
		[HDR]_ColorChangeNewCol3("New Color 3", Color) = (1, 1, 0, 1) //148

		_Contrast ("Contrast", Range(0, 6)) = 1 // 149
		_Brightness ("Brightness", Range(-1, 1)) = 0 // 150

		[HideInInspector] _MinXUV("_MinXUV", Range(0, 1)) = 0.0 //151
		...
		[HideInInspector] _RandomSeed("_MaxYUV", Range(0, 10000)) = 0.0 //155

		_StencilComp ("Stencil Comparison", Float) = 8 //156
		_Stencil ("Stencil ID", Float) = 0
		_StencilOp ("Stencil Operation", Float) = 0
		_StencilWriteMask ("Stencil Write Mask", Float) = 255
		_StencilReadMask ("Stencil Read Mask", Float) = 255 //160
