...
public class AllIn1SpriteShaderStencil : ShaderGUI
{
    ...
    public override void OnGUI(MaterialEditor materialEditor, MaterialProperty[] properties)
    {
        ...
        GenericEffect(materialEditor, properties, style, oldKeyWords.Contains("CONTRAST_ON"), "24.Contrast & Brightness", "CONTRAST_ON", 149, 150);
        ...
        if (toggle)
        {
            ...
            EditorGUILayout.BeginVertical(style);
            {
                ...
                if (toggle2)
                {
                    ...
                    for (int i = 143; i < 146; i++) materialEditor.ShaderProperty(properties[i], properties[i].displayName);
                }
        ...
        if (toggle)
        {
            ...
            EditorGUILayout.BeginVertical(style);
            {
                ...
                else
                {
                    ...
                    if (!simpleGradToggle) materialEditor.ShaderProperty(properties[138], properties[138].displayName);
